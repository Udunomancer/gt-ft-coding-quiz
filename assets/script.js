...
function populateQuestion(previousAns) {
  ...
  if (previousAns) {
    ...
    previousAnswer.setAttribute(
      "class",
      "text-muted border-top mt-3 w-25 text-center"
    );
...
function endGame() {
  //Function run to end active quiz questions
  //Input: none
  //Output: none
...
function populateScoreScreen() {
  ...
  //Create, add content, and add to DOM for Initials Submission
...
function submitHighScore() {
  ...
  //Set completed quiz object
  var submittedScore = {
    initials: document.querySelector("#initials").value,
    score: quizTime,
  };

  //Add completed quiz to stored quizzes obtained from local storage
